...
def follow(user1, user2):
    ...
    query = """
    MATCH (a:Usuario {username: $u1}),
          (b:Usuario {username: $u2})
...
def already_follows(user1, user2):
    ...
    query = """
    MATCH (u1:Usuario {username: $user1})
          -[r:SIGUE]->
          (u2:Usuario {username: $user2})
